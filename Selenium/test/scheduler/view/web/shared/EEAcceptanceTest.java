...
public abstract class EEAcceptanceTest extends DefaultSelTestCase {	
	...
	public void testAcceptanceForEE() throws InterruptedException {
		...
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 18, true, "EE", "342", "Classical Control Systems Lab", "2", "1", "1", "Tu", "3", "18", "LAB", null, null);
		...
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 25, true, "EE", "422", "Polymer Electronics Lab", "1", "1", "1", "Th", "3", "5", "LAB", null, null);
		...
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 31, true, "EE", "458", "Photonic Engineering Lab", "2", "1", "1", "Tu", "3", "12", "LAB", null, null);
		...
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 38, true, "EE", "521", "Computer Systems Lab", "1", "1", "1", "Th", "3", "32", "LAB", null, null);
