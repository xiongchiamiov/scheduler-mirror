...
public abstract class PHYSAcceptanceTest extends DefaultSelTestCase {	
	...
	public void setUp(WebDriver drv) throws java.io.IOException {
		...
		this.protoURL = properties.getProperty("domain") + "/PHYS";
	...
	public void testAcceptanceForGRC() throws InterruptedException {
		...
		final String documentName = "Winter 2012";
		...
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  1, true, "PHYS", "107", "Introduction to Meteorology",                   "1", "4", "4", "MTRF",       "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  2, true, "PHYS", "111", "Contemporary Physics for Nonscientists",        "1", "4", "3", "MWRF",        "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  3, true, "PHYS", "121", "College Physics 1",                             "6", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  4, true, "PHYS", "121", "College Physics 1",                            "10", "1", "1", "T",            "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  5, true, "PHYS", "122", "College Physics 2",                             "5", "4", "4", "TR",         "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  6, true, "PHYS", "122", "College Physics 2",                            "10", "1", "1", "TR",         "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  7, true, "PHYS", "123", "College Physics 3",                             "2", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  8, true, "PHYS", "123", "College Physics 3",                             "4", "1", "1", "M",            "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver,  9, true, "PHYS", "131", "General Physics 1",                             "5", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 10, true, "PHYS", "131", "General Physics 1",                             "9", "1", "1", "R,M,F",       "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 11, true, "PHYS", "132", "General Physics 2",                            "10", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 12, true, "PHYS", "132", "General Physics 2",                            "19", "1", "1", "W",            "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 13, true, "PHYS", "133", "General Physics 3",                             "7", "4", "4", "MWF,TR",     "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 14, true, "PHYS", "133", "General Physics 3",                            "14", "1", "1", "T,W,F",        "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 15, true, "PHYS", "141", "General Physics IA",                           "17", "4", "4", "MTWR",       "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 16, true, "PHYS", "200", "Special Problems for Undergraduates",           "8", "0", "0", "W",            "3", "30", "IND", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 17, true, "PHYS", "201", "Learning Center Tutor",                         "1", "0", "0", "",             "3", "30", "IND", "", null);	
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 18, true, "PHYS", "206", "Instrumentation in Experimental Physics",       "1", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 19, true, "PHYS", "211", "Modern Physics 1",                              "2", "4", "4", "MTWF,MTWR", "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 20, true, "PHYS", "256", "Electrical Measurements Laboratory",            "5", "1", "1", "T",            "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 21, true, "PHYS", "301", "Thermal Physics 1",                             "1", "4", "4", "MWRF",        "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 22, true, "PHYS", "317", "Special Theory of Relativity",                  "1", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 23, true, "PHYS", "323", "Optics",                                        "1", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 24, true, "PHYS", "323", "Optics",                                        "4", "1", "1", "T,R",        "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 25, true, "PHYS", "341", "Quantum Physics Laboratory 2",                  "5", "1", "1", "TR",         "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 26, true, "PHYS", "400", "Special Problems for Advanced Undergraduates", "10", "0", "0", "",             "3", "30", "IND", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 27, true, "PHYS", "409", "Electromagnetic Fields and Waves 2",            "1", "4", "4", "MWF",          "3", "30", "LEC", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 28, true, "PHYS", "461", "Senior Project 1",                              "5", "0", "0", "",             "3", "30", "IND", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 29, true, "PHYS", "462", "Senior Project 2",                              "5", "0", "0", "",             "3", "30", "IND", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 30, true, "PHYS", "463", "Senior Project - Laboratory Research 1",        "1", "1", "1", "S",            "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 31, true, "PHYS", "464", "Senior Project - Laboratory Research 2",        "1", "1", "1", "S",            "3", "30", "LAB", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 32, true, "PHYS", "485", "Cooperative Education Experience",              "1", "0", "0", "",             "3", "30", "IND", "", null);
		WebUtility.enterIntoCoursesResourceTableNewRow(driver, 33, true, "PHYS", "495", "Cooperative Education Experience",              "1", "0", "0", "",             "3", "30", "IND", "", null); 
