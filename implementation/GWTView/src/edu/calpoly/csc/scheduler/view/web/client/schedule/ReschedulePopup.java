...
public class ReschedulePopup extends DialogBox
{
 ...
 private void layoutDaysPanel()
 {
  ...
  for(Integer dayScheduled : rescheduled.getDayNums())
  {
   switch (dayScheduled)
   {
    case 1 : mondayCB.setValue(true); break;
    case 2 : tuesdayCB.setValue(true); break;
    case 3 : wednesdayCB.setValue(true); break;
    case 4 : thursdayCB.setValue(true); break;
    case 5 : fridayCB.setValue(true); break;
   }
  }
