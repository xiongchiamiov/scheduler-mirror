...
//				dropController = new ScheduleCellDropController((ScheduleCell) cell, this, includedListBox,	availableListBox);
...
//		}
//
//		dragController.registerDropController(dualListBoxCourses
//				.getAvailableDropController());
//
//		dragController.registerDropController(dualListBoxCourses
//				.getIncludedDropController());
//	}
...
//					registerDrops();
	...
	public void moveItem(final ScheduleItemGWT scheduleItem,
		...
		greetingService.rescheduleCourse(scheduleItem, days, startHour,
				atHalfHour, inSchedule, schedItems,
...
//								if (fromIncluded
//										|| sectionsIncluded
//												+ getSectionsOnSchedule(courseHolder) == availableListBox.getSectionsInBox(courseHolder)) {
...
//										includedListBox.setWidget(itemIndex, new CourseListItem(courseHolder, true));
//									}
