...
public class EditableTableConstants {
	...
	public static final String COURSE_LABPAD = "Lab Pad";
	
	public static final String COURSE_QUARTERID = "Quarter ID";
	
	public static final String COURSE_SCHEDULEID = "Schedule ID";
