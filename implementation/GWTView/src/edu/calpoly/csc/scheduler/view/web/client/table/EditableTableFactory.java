...
public class EditableTableFactory {
	...
	public static EditableTable createCourses(){
		...
		attr.add(new AttributeInfo(EditableTableConstants.COURSE_DEPARTMENT, AttributeInfo.INT));
		...
		attr.add(new AttributeInfo(EditableTableConstants.COURSE_NUM_SECTIONS, AttributeInfo.INT));
		...
		attr.add(new AttributeInfo(EditableTableConstants.COURSE_DAYS, AttributeInfo.INT));
		
		attr.add(new AttributeInfo(EditableTableConstants.COURSE_MAX_ENROLLMENT, AttributeInfo.INT));
		
		attr.add(new AttributeInfo(EditableTableConstants.COURSE_LAB, AttributeInfo.INT));
		
		attr.add(new AttributeInfo(EditableTableConstants.COURSE_LABPAD, AttributeInfo.INT));

		attr.add(new AttributeInfo(EditableTableConstants.COURSE_QUARTERID, AttributeInfo.INT));
		
		attr.add(new AttributeInfo(EditableTableConstants.COURSE_SCHEDULEID, AttributeInfo.INT));
