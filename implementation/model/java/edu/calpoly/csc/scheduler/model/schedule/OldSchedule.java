 ...
 */
public class OldSchedule extends Observable implements Serializable
{
    ...
    */
   public OldSchedule (Collection<ScheduleItem> s)
   {
      super ();
      /*
...
//               }
  ...
  /*<==*/ 
    ...
    *
    * @see edu.calpoly.csc.scheduler.model.schedule.OldSchedule#chooseBest
    */
...
/**
   ...
   public void replaceWithThisFromFile (OldSchedule s)
   {
      this.reset();
