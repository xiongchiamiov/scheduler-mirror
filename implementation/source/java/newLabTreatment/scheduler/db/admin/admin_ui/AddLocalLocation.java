...
/*
 * AddLocalLocation.java
 *
 * Created on Feb 21, 2010, 7:48:30 PM
 */
 ...
 * @author jsoliman
 */
public class AddLocalLocation extends MyView {
    ...
    /** Creates new form AddLocalLocation */
    public AddLocalLocation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        MaxOccupancyField = new javax.swing.JTextField();
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) { 
        ...
        try {
            ...
            else if (database.getData().contains(location)) {
                JOptionPane.showMessageDialog(this,
                "The location already exists in the databse.",
                "Error",
                 JOptionPane.ERROR_MESSAGE);        
            }
            else {
               database.addLocalLocation(location);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddLocalLocation().setVisible(true);
            }
        });
    }
