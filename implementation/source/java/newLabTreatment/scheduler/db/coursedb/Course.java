...
public class Course implements Serializable, Comparable<Course>
{
         ...
         DaysForClasses dfc, int hoursPerWeek, String ctPrefix)
   {
      ...
      System.err.println ("Made " + this.courseName);
      System.err.println ("Hours: " + this.hoursPerWeek);
	}
    ...
    * right now (15nov10), this makes a <b>shallow copy</b>.
    *
...
'	 */
   ...
   {
      int r = -1;
      System.err.println ("DIVIDE? " + hoursDivideIntoDays(numOfDays));
      System.err.println ("HOURS: " + this.hoursPerWeek);
