...
public class DayTab implements Observer {
   ...
   private void initVars() {
      ArrayList<DaysForClasses> existingPreferences;// = new ArrayList<DaysForClasses>();
      ArrayList<String> existingTitles;// = new ArrayList<String>();
      dayPanel = new JPanel();
   ...
   private void makeDayPreference(ActionEvent evt) {
     ...
     else if( !existingTitles.isEmpty() && existingTitles.contains(title) ) {
         prefLabel.setForeground(Color.RED);
     ...
     if(error_count == 0) 
     {
         try
         {
            Scheduler.pdb.addLocalDaysForClasses(new DaysForClasses(title,
                                                                    weight,
                                                                    week_pref));
            existingPreferences.add(new DaysForClasses(title,weight,week_pref));
   ...
   public ArrayList<DaysForClasses> getPreferences() {
      return existingPreferences;
   }
   
   
   private enum DAY { MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY };
   private ArrayList<DaysForClasses> existingPreferences = new ArrayList<DaysForClasses>();
   private ArrayList<String> existingTitles = new ArrayList<String>();
   private boolean M,T,W,R,F;
   private JPanel dayPanel;
   private JLabel prefLabel;
   private JLabel dayComboLabel;
   private JTextField prefNameField;
   private JToggleButton m_toggle;
   private JToggleButton t_toggle;
   private JToggleButton w_toggle;
   private JToggleButton r_toggle;
   private JToggleButton f_toggle;
