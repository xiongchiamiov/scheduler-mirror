 ...
 */
public class LocalCourseView extends MyView implements Observer {
    ...
    private AddCourseLocal addCourse;

    /** Creates new form LocalCourseView */
    public LocalCourseView() {
        database.addObserver(this);
        addCourse = new AddCourseLocal(database);
        initComponents();
...
//        jScrollPane1.setViewportView(ScheduleMenu.cList);
    ...
    private void initComponents() {
        ...
        AddCourseLocal = new javax.swing.JButton();
...
//        jScrollPane1.setViewportView(ScheduleMenu.cList);
        ...
        AddCourseLocal.setText("Add Course");
        AddCourseLocal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AddCourseLocalActionPerformed(evt);
            }
        });
        ...
        ViewList.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Name:", "Prefix:", "Course #:", "WTUs:", "SCUs:", "Class Type:", "Max Enrollment:", "Optional Fields", "Lab Pairing:", "Required Equipment:" };
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(AddSections, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addComponent(AddCourseLocal, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(AddCourseLocal)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(EditCourse)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(RemoveCourse)
                        .addGap(18, 18, 18)
                        .addComponent(AddSections)
                        .addGap(48, 48, 48))))
        );
     ...
     **/
    private void AddCourseLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddCourseLocalActionPerformed
        // TODO add your handling code here:
        addCourse.initialize();
        //addCourse.setVisible(true);
        addCourse.show(175, 175);
        System.out.println("In LocalCourseView.AddCourseLocalActionPerformed");
    }//GEN-LAST:event_AddCourseLocalActionPerformed
    ...
    private void EditCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditCourseActionPerformed
        // TODO add your handling code here:
        if (course.getId() >= 0) {
            EditLocalCourse editCourse = new EditLocalCourse(course);
            //editCourse.setVisible(true);
            editCourse.show(175,175);
        }
        System.out.println("In LocalCourseView.EditCourseActionPerformed");
    ...
    private void RemoveCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveCourseActionPerformed
        ...
        try {
            this.database.removeLocalCourse(removed);
        }
        catch (CourseDB.CourseDoesNotExistException e) {

        }
        jList1.clearSelection();
        System.out.println("In LocalCourseView.RemoveCourseActionPerformed");
    ...
    private void AddSectionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddSectionsActionPerformed
        ...
        System.out.println("In LocalCourseView.AddSectionsActionPerformed");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new LocalCourseView().setVisible(true);
            }
        });
    }
        ...
        if (!evt.getValueIsAdjusting()) {
            if (jList1.getSelectedValue() != null) {
               ...
               if (!selection.contains("L")) {
                  course = database.getLocalCourse(id, "Lecture");
               }
               else {
                  course = database.getLocalCourse(id, "Lab");
               }
               ...
               String[] strings = { "Name: " + course.getCourseName(), "Prefix: " + course.getPrefix(),
                                      ...
                                      "Max Enrollment: " + course.getMaxEnrollment(), "Class Day Preference: " + cdp, "Optional Fields",
    ...
    private javax.swing.JButton AddCourseLocal;
