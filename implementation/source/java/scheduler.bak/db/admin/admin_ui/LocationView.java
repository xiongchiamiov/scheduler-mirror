 ...
 * @author jsoliman
 */
public class LocationView extends MyView implements Observer {
    ...
    public void update(Observable obs, Object obj) {
        ...
        ArrayList<Location> data = (ArrayList) database.getData();
        if (data != null) {
            for (Location l: data ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(LocationList, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(AddLocation, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(EditLocation, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
                            .addComponent(RemoveLocation, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE))
    ...
    private void EditLocationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditLocationActionPerformed
        ...
        new EditLocation(location).show(175,175);
    ...
    private void RemoveLocationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveLocationActionPerformed
        ...
        this.database.removeLocation(removed);
        jList1.clearSelection();
        defaultFields();
        System.out.println("In LocationView.RemoveCourseActionPerformed");
    ...
    private void AvailableTimesButtonActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        //new LocationAvailability(location).setVisible(true);
    ...
    private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {
        ...
        if (!evt.getValueIsAdjusting()) {
            if (jList1.getSelectedValue() != null) {
               ...
               location = database.getLocation(selection);
               System.out.println ("Building is " + location.getBuilding());
