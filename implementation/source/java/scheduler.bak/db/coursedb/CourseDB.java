...
public class CourseDB extends Observable {
   ...
   public static final String courseFields = " (name, courseNum, wtus, scus, classType, maxEnrollment, labPairing, smartroom, overhead, laptop, prefix)";
   ...
   public Vector<Course> getLabs() {
      ...
      Course empty = new Course("", 0, 0, 0, "", 0, 0, null, false, false, false, "", null);
      courses.add(empty);
      for (Course c: data  ) {
         if (c != null) {
