 ...
 * @author jsoliman
 */
public class EditLocalLocation extends MyView {
    ...
    /** Creates new form EditLocalLocation */
    public EditLocalLocation(Location l) {
        this.location = l;
        initComponents();
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) { 
        ...
        try {
            ...
            if (building.equals("") || room.equals("")) {
               ...
               database.editLocalLocation(location);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new EditLocalLocation().setVisible(true);
            }
        });
    }
