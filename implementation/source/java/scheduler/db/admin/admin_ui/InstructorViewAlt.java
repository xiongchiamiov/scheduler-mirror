 ...
 */
public class InstructorViewAlt extends MyView implements Observer {
    ...
    private void AddInstructoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddInstructoActionPerformed
        ...
        AddInstructorAlt addInstructor = new AddInstructorAlt();
    ...
    private void EditInstructorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditInstructorActionPerformed
    	...
    	if (instructor != null) {
	        ...
	        EditInstructor editI = new EditInstructor(instructor);
	        editI.show(175,175);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(EditInstructor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(AddInstructo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {
        ...
        if (!evt.getValueIsAdjusting()) {
            if (jList1.getSelectedValue() != null) {
               ...
               instructor = database.getInstructorByName(selection);
    ...
    private void RemoveInstructorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveInstructorActionPerformed
    	...
    	if (instructor != null) {
	        ...
	        this.database.removeInstructor(removed);
    ...
    private void TimePreferencesActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
      if (instructor != null) {
    	   InstructorTimePrefs itp = new InstructorTimePrefs(instructor);
    	   itp.show(175,175);
         //itp.setVisible(true);
      }
    }
