...
public abstract class LocationsTest extends ModelTestCase {
	...
	public void testInsertAndFindLocation() throws NotFoundException {
		...
		
		{
			...
			locationID = model.insertLocation(model.assembleLocation(doc, "roomlol", "LEC", "30", new HashSet<String>())).getID();
		}
	...
	public void testModifyLocationValueDoesntAutomaticallyUpdateDatabase() throws NotFoundException {
		...
		{
			Document doc = model.insertDocument(model.assembleDocument("doc", START_HALF_HOUR, END_HALF_HOUR));
			Location ins = model.insertLocation(model.assembleLocation(doc, "roomlol", "LEC", "30", new HashSet<String>()));
	...
	public void testFindAllLocationsForDocument() {
		...
		Document doc = model.insertDocument(model.assembleDocument("doc", START_HALF_HOUR, END_HALF_HOUR));
		locationIDs.add(model.insertLocation(model.assembleLocation(doc, "roomlol", "LEC", "30", new HashSet<String>())).getID());
		locationIDs.add(model.insertLocation(model.assembleLocation(doc, "room2lol", "LEC", "20", new HashSet<String>())).getID());
	...
	public void testFindAllLocationsInMultipleDocuments() {
...

		{
			...
			locationIDs1.add(model.insertLocation(model.assembleLocation(doc1, "roomlol", "LEC", "30", new HashSet<String>())).getID());
			locationIDs1.add(model.insertLocation(model.assembleLocation(doc1, "room2lol", "LEC", "20", new HashSet<String>())).getID());
		...
		
		{
			...
			locationIDs2.add(model.insertLocation(model.assembleLocation(doc2, "room3lol", "LEC", "35", new HashSet<String>())).getID());
			locationIDs2.add(model.insertLocation(model.assembleLocation(doc2, "room4lol", "LEC", "30", new HashSet<String>())).getID());
