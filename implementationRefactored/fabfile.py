...
def deploy(*directories):
	...
	for directory in directories:
		...
		databasefilepath=/var/lib/tomcat6/webapps/DEPT/DatabaseState.javaser
		...
		applyServletPath=false" > war/WEB-INF/classes/edu/calpoly/csc/scheduler/view/web/server/scheduler.properties''')
		local("sed -i 's/DEPT/%s/' war/WEB-INF/classes/edu/calpoly/csc/scheduler/view/web/server/scheduler.properties" % directory)
