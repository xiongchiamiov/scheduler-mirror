                                   ...
                                   implements Serializable
{
    ...
    */
   public boolean book (boolean b, T t, int s, int e)//==>
   {
      /*
    ...
    */
   public boolean isFree (T t, int s, int e)//==>
   {
      roundTimeDown(s);
      roundTimeUp(e);
      int slots = computeSlots (s, e);
    ...
    *         otherwise.
    */
   public abstract boolean amIReallyFree (T t, int s, int e, BitSet timeSlot, 
                                  BitSet tSlot);
    ...
    */
   public int roundTimeDown (int t)//==>
   {
	   return t;
   }//<==
    ...
    */
   protected int computeSlots (int s, int e)//==>
   {
      int slots = (e - s) * 2;
      return slots;
   }//<==
    ...
    */
   protected int computeStartSlot (int s)//==>
   {
      return s;
   }//<==
