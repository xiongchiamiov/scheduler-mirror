 ...
 * @version 12nov10
 */
public class SiMap extends TreeMap<ScheduleItemDecorator, Void>
{
    ...
    */
   public SiMap (Vector<ScheduleItemDecorator> sis)
   {
      super();
    ...
    */
   public boolean put (ScheduleItemDecorator si)
   {
      if (si.getValue() == ScheduleItemDecorator.IMPOSSIBLE)
      {
         return false;
      }
      super.put(si, null);
    ...
    */
   public boolean putAll (List<ScheduleItemDecorator> list)
   {
      boolean r = true;
      for (ScheduleItemDecorator si: list)
      {
         r &= this.put(si);
      }
      return r;
    ...
    * @return this.lastKey();
    */
   public ScheduleItemDecorator getBest ()
   {
      return this.lastKey();
   }
}
