...
//	String openExistingSchedule(int scheduleID);
	...
	Integer openNewDocument(String newScheduleName);
	String openExistingDocument(int scheduleID);
	void saveDocument(int scheduleID);
	Integer saveDocumentAs(String scheduleName, boolean allowOverwrite);
