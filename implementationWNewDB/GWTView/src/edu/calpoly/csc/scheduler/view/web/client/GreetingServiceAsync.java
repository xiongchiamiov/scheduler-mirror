...
//	void saveCurrentScheduleAs(String schedName, AsyncCallback<Void> callback);
	...
	void openNewDocument(String newScheduleName, AsyncCallback<Integer> callback);
	void openExistingDocument(int scheduleID, AsyncCallback<String> callback);
	void saveDocument(int scheduleID, AsyncCallback<Void> callback);
	void saveDocumentAs(String scheduleName, boolean allowOverwrite,
