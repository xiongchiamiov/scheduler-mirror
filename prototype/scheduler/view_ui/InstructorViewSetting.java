 ...
 * @author Panda
 */
public class InstructorViewSetting extends javax.swing.JFrame {

    /** Creates new form ViewUI */
    public InstructorViewSetting() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Instructor Schedule Viewing Options");
        ...
        coursePanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Select Instructor"));

        jCheckBox1.setText("Bellardo, John");

        jCheckBox2.setText("Buckalew, Chris");

        jCheckBox3.setText("Clark, Chris");

        jCheckBox4.setText("Clements, John");

        jCheckBox5.setText("Dekhtyar, Alex");

        jCheckBox6.setText("Fisher, Gene");

        jCheckBox7.setText("Gharibyan, Hasmik");

        jCheckBox8.setText("Haungs, Michael");

        jCheckBox9.setText("Janzen, David");

        jCheckBox10.setText("Keen, Aaron");
        ...
        jCheckBox11.setText("Kurfess, Aaron");

        jCheckBox12.setText("Liu, Mei-Ling");

        jCheckBox13.setText("Lupo, Chris");

        jCheckBox14.setText("Nico, Phillip");

        jCheckBox15.setText("Seng, John");

        jCheckBox16.setText("Smith, Hugh");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InstructorViewSetting().setVisible(true);
            }
        });
    }
